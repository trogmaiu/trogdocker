...
2: <form action="passar3.php"method="GET">
<input type="submit" name="vai2" value="Executar">
</form> <br>


3: <form action="passar3.php"method="GET">
<input type="submit" name="vai3" value="Executar">
</form> <br>
